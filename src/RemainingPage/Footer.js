  ...
  return (
   ...
   <div className='d-flex flex-row flex-wrap p-1 justify-content-between ms-4'>
    ...
    <div className='d-flex me-3'>
     ...
     <div>
     <Link to="#" className='cnt-text nolink'>Contact on Telegram</Link>
      </div>
      </div>
...
<Link to='/about' className='cnt-text nolink'>About us</Link>
   ...
   © Copyright 2023. All Rights Reserved to the Abhishek Kumar
   </div >
    </footer>
  )
}
